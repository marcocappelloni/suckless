...
//static const char *passmenucmd[] = { "passmenu", "-l", "15", NULL };
//static const char *simplecalcmd[] = { "gsimplecal", NULL };
//static const char *incvol[] = {"/usr/bin/pactl", "set-sink-volume", "0", "+5%", NULL};
//static const char *decvol[] = {"/usr/bin/pactl", "set-sink-volume", "0", "-5%", NULL};
